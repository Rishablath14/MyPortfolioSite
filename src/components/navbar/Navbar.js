...
<AnimatePresence>
        {showMenu && (
          <motion.div initial={{x:"-100%"}} transition={{ ease: "easeOut", duration: 1 }} animate={{x:0}} exit={{x:"-100%"}} className="w-[100%] h-screen overflow-scroll absolute top-0 left-[-15px] bg-[#191b1e] p-10 scrollbar-hide">
